<?php include '../Author/inc/header.php'; ?>
<?php include '../Author/inc/sidebar.php'; ?>
<!--main-container-part-->
<div id="content">
<!--breadcrumbs-->
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="dashboard.php"> <i class="icon-dashboard"></i> <span class="label label-important">20</span> My Dashboard </a> </li>
       
       
        <li class="bg_lo"> <a href="tables.php"> <i class="icon-th"></i> Tables</a> </li>
        <li class="bg_ls"> <a href="grid.php"> <i class="icon-fullscreen"></i> Full width</a> </li>
